...
const HeroOffline = () => {
  ...
  const features = [
    {
      title: "Check Balance",
      desc: "View your account balance offline.",
      icon: <AccountBalanceIcon />,
      link: "/checkbalanceoffline",
      gradient: "from-amber-400 via-orange-500 to-red-500",
      color: "amber",
    },
    {
      title: "Pay via UPI",
      desc: "Make UPI payments without internet.",
      icon: <TollIcon />,
      link: "/payUpiOffline",
    ...
    {
      title: "Pay Online",
      desc: "Switch to online payment mode.",
    ...
    {
      title: "Scan QR",
      desc: "Scan QR codes for offline payments.",
    ...
    },
    {
      ...
      desc: "View offline transactions.",
      icon: <ReceiptLongIcon />,
      link: "/transactionOffline",
      gradient: "from-pink-400 via-rose-500 to-red-500",
      color: "pink",
    },
    {
      title: "Budget Tracker",
      desc: "Track monthly budget.",
      ...
      <div className="min-h-screen bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800 py-12 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-12">
            Manage your finances even without internet.
          </p>
